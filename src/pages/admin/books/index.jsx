            ...
            <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
              ...
              <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                <Link to={"/admin/books/create"}>
                  <button
                    type="button"
                    className="cursor-pointer flex items-center justify-center text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 focus:outline-none dark:focus:ring-indigo-800"
                  >
                    <svg
              ...
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                  <tr>
                    ...
                    <th scope="col" className="px-4 py-3">Cover Photo</th>
                  ...
                  {filteredBooks.length > 0 ? (
                    filteredBooks.map((book) => (
                      <tr key={book.id} className="border-b dark:border-gray-700">
                        ...
                        <td className="px-4 py-3">{formatCurrencyWithDecimal(book.price)}</td>
                        <td className="px-4 py-3">{book.stock} pcs</td>
                    ...
                    <tr className="border-b dark:border-gray-700">
                      <td colSpan="7" className="px-4 py-3 text-center font-medium text-gray-900 dark:text-white">
                        {searchTerm ? "No books found matching your search." : "Data Not Found!"}
                      </td>
                    </tr>
                  )}
                </tbody>
