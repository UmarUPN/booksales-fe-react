        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-8">
            <div className="w-full">
              <h2 className="text-3xl font-bold mb-4 relative after:content-[''] after:block after:w-12 after:h-1 after:bg-indigo-500 after:mx-auto after:mt-5">
                Meet Our Team
              </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Team Member 1 */}
            <div className="team-member text-center p-6 transition-transform duration-300 ease-in-out hover:-translate-y-2">
              <img
                src="https://randomuser.me/api/portraits/women/64.jpg"
                alt="Team Member 1"
                className="w-48 h-48 object-cover rounded-full border-4 border-gray-100 mx-auto mb-6 shadow-lg transition-transform duration-300 ease-in-out hover:scale-105"
              />
              <h5 className="font-bold text-lg mb-2">Sarah Johnson</h5>
              <p className="text-gray-600 mb-4">CEO & Founder</p>
              <p className="text-sm text-gray-600 mb-4">
                Leading our company's vision and strategy with over 15 years of
                experience.
              </p>
              <div className="team-social-links flex justify-center space-x-2">
                <a
                  href="#"
                  className="w-9 h-9 bg-gray-100 text-indigo-500 rounded-full flex items-center justify-center transition-all duration-300 hover:bg-indigo-500 hover:text-white hover:-translate-y-1"
                >
            ...
            <div className="team-member text-center p-6 transition-transform duration-300 ease-in-out hover:-translate-y-2">
              <img
                ...
                className="w-48 h-48 object-cover rounded-full border-4 border-gray-100 mx-auto mb-6 shadow-lg transition-transform duration-300 ease-in-out hover:scale-105"
              />
              <h5 className="font-bold text-lg mb-2">Umar Mukhtar</h5>
              <p className="text-gray-600 mb-4">Fullstack Web Developer</p>
              <p className="text-sm text-gray-600 mb-4">
                Turning ideas into interactive, scalable web platforms.
              </p>
              <div className="team-social-links flex justify-center space-x-2">
                <a
                  href="mailto:el.mochtaar@gmail.com"
                  className="w-9 h-9 bg-gray-100 text-indigo-500 rounded-full flex items-center justify-center transition-all duration-300 hover:bg-indigo-500 hover:text-white hover:-translate-y-1"
                >
                  <i className="far fa-envelope"></i>
                </a>
                <a
                  href="https://github.com/UmarUPN"
                  target="_blank"
                  className="w-9 h-9 bg-gray-100 text-indigo-500 rounded-full flex items-center justify-center transition-all duration-300 hover:bg-indigo-500 hover:text-white hover:-translate-y-1"
                >
                ...
                <a
                  href="https://www.instagram.com/el_mochtaar/"
                  target="_blank"
                  className="w-9 h-9 bg-gray-100 text-indigo-500 rounded-full flex items-center justify-center transition-all duration-300 hover:bg-indigo-500 hover:text-white hover:-translate-y-1"
                >
            ...
            <div className="team-member text-center p-6 transition-transform duration-300 ease-in-out hover:-translate-y-2">
              <img
                ...
                className="w-48 h-48 object-cover rounded-full border-4 border-gray-100 mx-auto mb-6 shadow-lg transition-transform duration-300 ease-in-out hover:scale-105"
              />
              <h5 className="font-bold text-lg mb-2">Emily Martinez</h5>
              <p className="text-gray-600 mb-4">Design Director</p>
              <p className="text-sm text-gray-600 mb-4">
                Creating beautiful and intuitive designs that users love.
              </p>
              <div className="team-social-links flex justify-center space-x-2">
                <a
                  href="#"
            ...
            <div className="team-member text-center p-6 transition-transform duration-300 ease-in-out hover:-translate-y-2">
              <img
                ...
                className="w-48 h-48 object-cover rounded-full border-4 border-gray-100 mx-auto mb-6 shadow-lg transition-transform duration-300 ease-in-out hover:scale-105"
              />
              <h5 className="font-bold text-lg mb-2">David Wilson</h5>
